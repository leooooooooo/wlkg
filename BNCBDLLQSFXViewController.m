...
@interface BNCBDLLQSFXViewController ()
...
@implementation BNCBDLLQSFXViewController
...
-(void)loadChartAndTabel
{
    ...
    NSString *bodyStr = [NSString stringWithFormat:@"ServiceNum=%@",@"7"];
    //将nstring转换成nsdata
