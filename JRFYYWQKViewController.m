...
@interface JRFYYWQKViewController ()
@property (nonatomic,retain) NSArray *ChartDate;
@end

@implementation JRFYYWQKViewController
...
-(void)loadChartAndTabel
{
    ...
    NSString *bodyStr = [NSString stringWithFormat:@"ServiceNum=%@",@"11"];
    //将nstring转换成nsdata
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSArray *name = [[NSArray alloc]initWithObjects:@"火车",@"汽车",@"年累计发运量",@"", nil];
    //Date
