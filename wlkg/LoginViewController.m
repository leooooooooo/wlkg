...
-(IBAction)signinbt{
    ...
    [NSURLConnection sendAsynchronousRequest:request queue:[NSOperationQueue mainQueue] completionHandler:^(NSURLResponse *response, NSData *data, NSError * error) {
        ...
        if (data != nil) {  //接受到数据，表示工作正常
            ...
            if([[Info objectForKey:@"IsLogin"]isEqualToString:@"True"])
            {
                //保存登录信息
                ...
                UINavigationController *mainViewController=[[UINavigationController alloc]initWithRootViewController:index];
                //mainViewController.view.backgroundColor=[UIColor grayColor];
                
                MenuTableViewController *leftViewController=[[MenuTableViewController alloc]initWithNibName:nil bundle:nil];
    ...
    [NSURLConnection sendAsynchronousRequest:request queue:[NSOperationQueue mainQueue] completionHandler:^(NSURLResponse *response, NSData *data, NSError * error) {
        ...
        if (data != nil) {  //接受到数据，表示工作正常
            ...
            if([[Update objectForKey:@"Update"]isEqualToString:@"Yes"])
            {
                ...
                [newVersion setTitleColor:[UIColor orangeColor] forState:UIControlStateNormal];
