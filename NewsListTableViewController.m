...
-(NSMutableArray *)getArray:(long)page
{
    ...
    switch (self.mark) {
        case 16://要闻咨询
            ...
            break;
        case 17://领导讲话
            URL = [NSString stringWithFormat:@"http://218.92.115.55/wlkg/Service/News/LeaderSpeech/GetLeaserSpeechNewsList.aspx?UserId=&Pages=%d&Filter=",loadCount];
            break;
        case 18://基层动态
            URL = [NSString stringWithFormat:@"http://218.92.115.55/wlkg/Service/News/BasicLevel/GetBasicLevelNewsList.aspx?UserId=&Pages=%d&Filter=",loadCount];
            break;
        case 19://党建新闻
            URL = [NSString stringWithFormat:@"http://218.92.115.55/wlkg/Service/News/PartyBuilding/GetPartyBuildingNewsList.aspx?UserId=&Pages=%d&Filter=",loadCount];
            break;
        default:
            break;
    }
    ...
    return [Json objectForKey:@"ConmpanyNewsList"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSURL *URL = [[NSURL alloc]initWithString:[NSString stringWithFormat:@"http://218.92.115.55/wlkg/Service/News/NewsDetail.html?info=%@+%@",newsType,newsID]];
